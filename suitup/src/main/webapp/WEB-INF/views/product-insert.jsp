					...
					<div class="row">
						<div class="col-xs-12">
							<div class="bradcaump__inner text-center">
								<h2 class="bradcaump-title">상품등록</h2>
								<nav class="bradcaump-inner">
									<a class="breadcrumb-item" href="index.jsp">홈</a> <span
										class="brd-separetor">/</span> <span
										class="breadcrumb-item active">상품등록</span>
								</nav>
							</div>
						</div>
					</div>
                            ...
                            <input type="hidden" name="n" value="${vo.proNum}" />
									...
									<label>1차 분류</label> <select id="category" class="category1"
										...
										<c:forEach items="${categoryList}" var="list">
											...
											<c:if test='${prevNum ne list.cateNum}'>
												<option value="${list.cateNum}">${list.cateName}</option>
										...
										<c:forEach items="${categoryList}" var="list">
											<option pro-value="${list.cateNum}" value="${list.cateDtnum}">${list.cateDtname}</option>
										</c:forEach>
								...
								<div class="inputArea">
									<label for="proName">상품명</label> <input type="text"
										id="proName" name="proName" required/>
								</div>

								<div class="inputArea">
									<label for="proPrice">상품가격</label> <input type="text"
										id="proPrice" name="proPrice" required/>
								</div>
								...
								<div class="inputArea">
									<label for="detail">상품 설명 이미지</label>
